        ...
        <div class="span8">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding clearfix">
                        ...
                        <table class=" table table-bordered">
                            ...
                            <%-- <s:iterator value="#systemUsers">
	                            <tr>
	                                ...
	                                <td><a href="systemUserAction?method:editSystemUser=xxx&userId=<s:property value="userId"/>"><s:property value="userName"/></a></td>
                    ...
                    <hr>
                    <div class="clearfix">
                        <div class="span2"><a href="add-sys-user.jsp" class="btn btn-block ">添加</a></div>
            ...
            <div class="pagination alternate text-center">
                <ul>
	                ...
	                <s:else>
	                    <li class="disabled"><a href="${pageContext.request.contextPath}/systemUserAction?method:getPageList=xxx&page=1">首页</a></li>
	                    <li class=""><a href="${pageContext.request.contextPath}/systemUserAction?method:getPageList=xxx&page=<s:property value="%{pageBean.currentPage-1}"/>">上一页</a></li>
                    </s:else>
                    <s:if test="%{pageBean.currentPage != pageBean.totalPage}">
                    	<li><a href="${pageContext.request.contextPath}/systemUserAction?method:getPageList=xxx&page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a></li>
                    	<li><a href="${pageContext.request.contextPath}/systemUserAction?method:getPageList=xxx&page=<s:property value="pageBean.totalPage"/>">尾页</a></li>
                    </s:if>
                    <s:else>
	                    <li><a href="#">下一页</a></li>
	                    <li><a href="#">尾页</a></li>
