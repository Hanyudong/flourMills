...
<html>
  ...
  <div id="sidebar">
    ...
    <ul>
      ...
      <li class="submenu active"><a href="#"><i class="icon icon-file"></i> <span>收入支出流水登记</span></a>
        <ul>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.jsp" title="回到主页" class="tip-bottom"><i class="icon-home"></i>主页</a> <a href="registration.jsp" class="current">收入支出流水登记</a> </div>
      <h1>收入支出流水登记</h1>
    </div>
