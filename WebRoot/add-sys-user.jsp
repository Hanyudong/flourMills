        ...
        <div class="span6">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form action="systemUserAction" method="post" class="form-horizontal clearfix">
						<input type="hidden" name="method:addSystemUser" value="xyz">
                        <div class="form-group clearfix">
                            <lable for="username" class="span3">用户名称</lable>
                            <div class="span7">
                                <input type="text" id="userName" name="userName" value=""title="用户名称"  required="required">
                                <span>*</span>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            <lable for="name" class="span3">姓名</lable>
                            <div class="span7">
                                <input type="text" id="realName" name="realName" value="" title="姓名"  required="required">
                                <span>*</span>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            <lable for="phone" class="span3">联系电话</lable>
                            <div class="span7">
                                <input type="tel" id="phone" name="phone" value="" title="联系电话"  required="required">
                                <span>*</span>
                            </div>
                        </div>
                        <div class="span3"></div>
                        <div class="btn-group span5">
                            ...
                            <button type="reset" class="btn btn-default" onclick="back()">取消</button>
                        </div>
                        <div class="span3"></div>
                    </form>
                </div>
