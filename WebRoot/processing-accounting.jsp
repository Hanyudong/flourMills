...
<html>
  ...
  <div id="content">
    ...
    <div id="content-header">
      <div id="breadcrumb">
        <a href="index.jsp" title="返回主页" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="processing-accounting.jsp">面粉加工查询</a>
      </div>
      <h1>面粉加工查询</h1>
    </div>
    <!--End-breadcrumbs-->
              ...
              <table class="table table-bordered table-invoice">
                <tbody>
                  <tr>
                    ...
                    <td class="width70"><strong>笔记本电脑</strong></td>
                  </tr>
                  <tr>
                    <td>分类</td>
                  ...
                  <tr>
                    <td>抢购</td>
                    <td><a href="javascript:;">抢购</a></td>
                  </tr>
                  <tr>
                    <td class="width30">描述</td>
                    <td class="width70"><br>
