...
<html>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.jsp" title="回到主页" class="tip-bottom"><i class="icon-home"></i>主页</a>
        <a href="customer-management.jsp" class="current">客户管理</a> </div>
      <h1>客户管理</h1>
    </div>
      ...
      <div class="span8">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding clearfix">
              ...
              <table class=" table table-bordered">
                ...
                <s:iterator value="#customers">
	                <tr>
	                  ...
	                  <td><a href="customerAction?method:editCustomer=xxx&customerId=<s:property value="customerId"/>"><s:property value="customerName"/></a></td>
            ...
            <hr>
            <div class="clearfix">
              <div class="span2"><a href="add-costomer.jsp" class="btn btn-block ">添加</a></div>
              ...
              <div class="span2"></div>
              <div class="span2">
                <a id="choice" class="btn btn-block">全部选择</a>
              </div>
              <div class="span2">
                <a id="cancel" class="btn btn-block">全部取消</a>
              </div>
            </div>
            <hr>
        ...
        <div class="pagination alternate text-center">
          ...
          <!-- 
	       ...
	       <s:else>
	            <li class="disabled"><a href="${pageContext.request.contextPath}/customerAction?method:getPageList=xxx&page=1">首页</a></li>
	            <li class=""><a href="${pageContext.request.contextPath}/customerAction?method:getPageList=xxx&page=<s:property value="%{pageBean.currentPage-1}"/>">上一页</a></li>
           </s:else>
           <s:if test="%{pageBean.currentPage != pageBean.totalPage}">
                <li><a href="${pageContext.request.contextPath}/customerAction?method:getPageList=xxx&page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a></li>
                <li><a href="${pageContext.request.contextPath}/customerAction?method:getPageList=xxx&page=<s:property value="pageBean.totalPage"/>">尾页</a></li>
           </s:if>
           <s:else>
	            <li><a href="#">下一页</a></li>
	            <li><a href="#">尾页</a></li>
