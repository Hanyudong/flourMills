...
<html>
  ...
  <div id="sidebar">
    ...
    <ul>
      ...
      <li class="submenu active"><a href="#"><i class="icon icon-file"></i> <span>凭证打印</span></a>
        <ul>
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.jsp" title="回到主页" class="tip-bottom"><i class="icon-home"></i>主页</a>
        <a href="document-printing.jsp" class="current">凭证打印</a> </div>
      <h1>凭证打印</h1>
    </div>
              ...
              <table class="table table-bordered data-table">
                ...
                <tbody>
                  <tr class="gradeX">
                    <td>俞常爽</td>
                    <td>us后台管理系统搭建</td>
                    <td><strong>便生活便生活便生活便生活便生活便生活</strong></td>
