...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="index.jsp" title="回到主页" class="tip-bottom"><i class="icon-home"></i>主页</a> <a
                href="mandatory-management.jsp" class="current">欠款催收管理</a></div>
        <h1>客户欠款纵览</h1>
    </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span10">
            <div class="widget-box">
                ...
                <div class="span12">
                    <div id="tips" class="text-right">
                        <span></span>
                        <span>代表应收金额</span>
                        <span></span>
                        <span>代表应付金额</span>
                        <p>身份证编码：130324196612165426</p>
                    </div>
                </div>
                <div class="container">
                        ...
                        <div class="span12">
                            <table class="table table-bordered">
                                ...
                                <tr class="green">
                                    ...
                                    <td>1.0</td>
                                    <td>
                                        <button class="btn-success btn">清算</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="span12 text-center">
                        <button id="reset" class="btn-success btn">返回</button>
                    </div>
                </div>
            </div>
        </div>
