        ...
        <div class="span6">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form action="productTypeAction" method="get" class="form-horizontal clearfix">
						<input type="hidden" name="method:addProductType" value="xyz">
                        <div class="form-group clearfix">
                            <lable for="username" class="span3">产品类型名称</lable>
                            <div class="span7">
                                <input type="text" id="username" name="typeName" value=""title="产品类型名称"  required="required">
                                <span>*</span>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            <lable for="name" class="span3">商品类型</lable>
                            <div class="span7">
                                <input type="text" id="name" name="productName" value="面粉" title="商品类型" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            <lable for="phone" class="span3">出粉率</lable>
                            <div class="span7">
                                <input type="text" id="percentage" name="rate" value="" title="出粉率"  required="required">
                                <span>%</span>
                                <span>*</span>
                            </div>
                        </div>
