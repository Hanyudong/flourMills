        ...
        <div class="span6">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form action="customerAction" method="get" class="form-horizontal clearfix">
						<input type="hidden" name="method:addCustomer" value="xyz">
                        <div class="form-group clearfix">
                            <lable for="username" class="span3">客户姓名/企业名称</lable>
                            <div class="span7">
                                <input type="text" id="username" name="customerName" value=""title="客户姓名/企业名称"  required="required">
                                <span>*</span>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            ...
                            <div class="span7">
                                <input type="text"  value="" name="address" title="联系地址"  required="required">
                                <span>*</span>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            ...
                            <div class="span7">
                                <input type="text" name="idCard" id="idCard" value="" required="required">
                                <span>*</span>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            ...
                            <div class="span7">
                                <input type="tel" id="phone" name="mobile" value="" title="联系电话">
                            </div>
                        </div>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="span7">
                                <input type="tel" name="" value="" title="联系电话">
                            </div>
                        </div>
                        <div class="span3"></div>
...
<script src="js/check_idCard.js"></script>
